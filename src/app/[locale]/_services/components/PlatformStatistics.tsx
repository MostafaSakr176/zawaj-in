...
const DEFAULT_STATS: Stat[] = [
  {
    icon: <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M22.1641 33.832V36.1654" stroke="#301B69" strokeWidth="3" stroke-miterlimit="10" strokeLinecap="round" />
      <path d="M33.8359 33.832V36.1654" stroke="#301B69" strokeWidth="3" stroke-miterlimit="10" strokeLinecap="round" />
  ...
  },
  {
    icon: <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M22.1641 24.5V26.8333" stroke="#301B69" strokeWidth="3" stroke-miterlimit="10" strokeLinecap="round" />
      <path d="M33.8359 24.5V26.8333" stroke="#301B69" strokeWidth="3" stroke-miterlimit="10" strokeLinecap="round" />
    </svg>
